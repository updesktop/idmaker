  ...
  var jmenu=
    '<div style="width:100%;height:100%;">'+
      ...
      '<div style="float:right;width:58%;height:100%;color:'+JBE_TXCLOR1+';background:none;">'+    
        ...
        '<input type="file" id="up_img" data-orig="" name="up_img" hidden="hidden" />'+
        '<div id="custom-img" style="display:block;float:right;cursor:pointer;height:100%;width:auto;background:white;">'+
          '<img id="pre_img" name="pre_img" data-img="" onclick="JBE_GET_IMAGE(0,up_img.id,pre_img.id,&quot;&quot;,false)" src="main_gfx/jimage.png" style="height:100%;width:40px;" />'+
        '</div>'+
      '</div>'+
